...
# OBS @Adrian K. / Phonevox Group Technology
#
# Literalmente o mesmo script, só removi o sleep 60. 
#
# Sei que está depreciado, mas quero continuar utilizando-o
# tendo ciência dos riscos de usar uma versão depreciada
...
if [[ $DISTRO_PKG =~ ^system-release-2-1(4|5|6) ]]; then
